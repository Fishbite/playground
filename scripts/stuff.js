...
// let Jan01_1970 = new Date(0); // add parameter 0
// console.log(Jan01_1970); // Date Thu Jan 01 1970 01:00:00 GMT+0100 (Greenwich Mean Time)

// // now add 24 hours, get 02.01.1970 UTC+0
// let Jan02_1970 = new Date(24 * 3600 * 1000); // No. of hours in day * seconds in hour * ms in second
// console.log(Jan02_1970); // Date Fri Jan 02 1970 01:00:00 GMT+0100 (Greenwich Mean Time)

// // now add 365 days (365 * 24)
// let Jan01_1971 = new Date(365 * 24 * 3600 * 1000);
// console.log(Jan01_1971); // Date Fri Jan 01 1971 01:00:00 GMT+0100 (Greenwich Mean Time)

// // new date using a date string:
// let date = new Date("1965-01-26");
// console.log(date); // Date Tue Jan 26 1965 00:00:00 GMT+0000 (Greenwich Mean Time)
// // The time is not set, so it's assumed to be midnight GMT and
// // is adjusted according to the timezone the code is run in
// // So the result could be
// // Tue Jan 26 1965 11:00:00 GMT+1100 (Australian Eastern Daylight Time)
// // or
// // Mon Jan 25 1965 16:00:00 GMT-0800 (Pacific Standard Time)

// // or, Create a new date object using components of the local time zone
// // new Date(year, month, date, hours, minutes, seconds, ms)
// // NOTE: DATE is actually the DAY of THE Month if omitted 1 is assumed
// console.log(new Date(2024, 0)); // only the first two components are obligatory
// // Date Mon Jan 01 2024 00:00:00 GMT+0000 (Greenwich Mean Time)
// // if hours, mins, seconds, milliseconds are omitted, they are assumed to be 0
// // Date Mon Jan 01 2024 00:00:00 GMT+0000 (Greenwich Mean Time)

// // maximum precision is 1 ms

// // methods to get the year, month etc...
// // new Date().getFullYear(); // 4 digit year
// // new Date().getMonth(); // month from 0 to 11
// // new Date().getDate(); // day of the month from 1 to 31
// // new Date().getHours(), getMinutes(), getSeconds(), getMilliseconds(); // time components
// // new Date().getDay(); // day of the week from 0 (Sunday) to 6 (Saturday)
...
// //  ****** Special Methods:::::-
// console.log(new Date().getTime()); // 1710873717823 = No. of ms since 1st Jan 1970 UTC+0
// console.log(new Date().getHours()); // 18 Current hour in the current time zone i.e. 18:00 hrs

// // Auto Correction: out of range values are auto-corrected e.g.
// console.log(new Date(2024, 0, 32)); // Date Thu Feb 01 2024 00:00:00 GMT+0000 (Greenwich Mean Time)

// // When a date is converted to a number it becomes the timestamp, same as `.getTime()`
// date = new Date();
// console.log(+date); // 1710875406046

// // the above is important as it means dates can be subtracted:
// let start = new Date(); // date now - START time
// for (let i = 0; i < 100000; i++) {
//   let doThis = i ** (i ** i);
// }
// let end = new Date(); // date now - END time
// console.log(end - start); // returns difference in ms

// // SPEED IS IMPORTANT!!!!!!
// // If we only want to measure time we don't need the `Date` object so we can use
// // `Date.now()` which just returns the timestamp, without creating the
// // itermediary `Date` object, so it's a lot quicker - good for gaming calc's etc..

// start = Date.now(); // START timestamp
// for (let i = 0; i < 100000; i++) {
//   let doThis = i ** (i ** i);
// }
// end = Date.now(); // END timestamp
...
// // NOTE: first executions are not well optimized so to run a good benchmark
// // do "Heat Up" run first:
...
// // TASK write a function to return the weekday "MO, TU, WE, TH, FR, SA, SU"
...
//   return (n * (n + 1)) / 2;
// }
// console.log(sumToFormula(100)); // fastest. Only 3 operations on `n`
...
//   return sum;
// }
// console.log(sumTo(100)); // 2nd fastet `n` operations on `sum`
...
//   }
// }
// console.log(recursiveSumTo(100)); // slowest because of nested calls & stack management
